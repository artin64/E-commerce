    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    StoreKey = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WishlistItems_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WishlistItems_Users_BuyerUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_BuyerUserId",
                table: "ChatMessages",
                column: "BuyerUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_StoreId_ProductId_CreatedAtUtc",
                table: "ChatMessages",
                columns: new[] { "StoreId", "ProductId", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_VendorUserId",
                table: "ChatMessages",
                column: "VendorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GiftCards_StoreId_Code",
                table: "GiftCards",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_StoreId_CreatedAtUtc",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_StoreId_ProductId_CreatedAtUtc",
                table: "Reviews",
                columns: new[] { "StoreId", "ProductId", "CreatedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishlistItems_BuyerUserId",
                table: "WishlistItems",
                column: "BuyerUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishlistItems_StoreId_BuyerUserId_ProductId",
                table: "WishlistItems",
                columns: new[] { "StoreId", "BuyerUserId", "ProductId" },
                unique: true);

            migrationBuilder.AddForeignKey(
                name: "FK_Ads_Stores_StoreId",
                table: "Ads",
                column: "StoreId",
                principalTable: "Stores",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ChatMessages_Users_BuyerUserId",
                table: "ChatMessages",
                column: "BuyerUserId",
                principalTable: "Users",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ChatMessages_Users_VendorUserId",
                table: "ChatMessages",
                column: "VendorUserId",
                principalTable: "Users",
                principalColumn: "Id",
